        ...
        <View className="flex-1 justify-center px-6">
          ...
          <View className="mt-8">
            ...
            <TextInput
              ...
              style={inputText}
              className="rounded-xl border border-neutral-200 bg-neutral-0 px-4 py-4 text-base text-ink dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-50"
              returnKeyType="next"
